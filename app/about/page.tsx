  ...
  return (
    <main className="flex flex-col md:basis-1/3 md:items-center md:text-2xl justify-center px-10">
      <div className="md:text-base max-h-[38rem] text-clip overflow-y-auto">
        ...
        design. i have experience with <b>wordpress</b>, <b>vue.js</b>,{' '}
        <b>react</b>, <b>react native</b> and some back-end experience with
        django, laravel, and node.js. i&apos;m currently working with{' '}
        <b>next.js</b>, <b>tailwindcss</b>, and <b>typescript</b>.
      </div>
